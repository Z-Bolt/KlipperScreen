...
class FineTunePanel(ScreenPanel):
    ...
    def initialize(self, panel_name):
        ...
        self.labels['z+'] = self._gtk.ButtonImage("z-farther", _("Increase offset"), "color1")
        ...
        self.labels['z-'] = self._gtk.ButtonImage("z-closer", _("Reduce offset"), "color1")
        self.labels['z-'].connect("clicked", self.change_babystepping, "-")
        ...
        self.labels['speed+'] = self._gtk.ButtonImage("speed+", _("Increase speed"), "color3")
        ...
        self.labels['speed-'] = self._gtk.ButtonImage("speed-", _("Reduce speed"), "color3")
        self.labels['speed-'].connect("clicked", self.change_speed, "-")
        grid.attach(self.labels['speed+'], 1, 0, 1, 1)
        grid.attach(self.labels['speedfactor'], 1, 1, 1, 1)
        grid.attach(self.labels['speed-'], 1, 2, 1, 1)

        self.labels['extrude+'] = self._gtk.ButtonImage("flow+", _("Increase flow"), "color4")
        ...
        self.labels['extrude-'] = self._gtk.ButtonImage("flow-", _("Reduce flow"), "color4")
        self.labels['extrude-'].connect("clicked", self.change_extrusion, "-")
